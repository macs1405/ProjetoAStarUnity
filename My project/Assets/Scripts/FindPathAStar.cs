...
public class FindPathAStar : MonoBehaviour
{
    ...
    void BeginSearch()
    {
        ...
        List<MapLocation> location = new List<MapLocation>();
        ...
        goalNode = new PathMaker(new MapLocation(locations[1].x, locations[1].z), 0, 0, 0,
    ...
    void Search(PathMaker thisNode)
    {
        ...
        foreach(MapLocation dir in maze.directions)
        {
            ...
            float H = Vector2.Distance(neighbour.toVector2(), goalNode.location.ToVector());
            float F = G + H;
        ...
        open = open.OrderBy(p => p.F).ThenBy(n => n.H).ToList<PathMaker>();
        PathMaker pm = (PathMaker) open.ElementAt(0);
        closed.Add(pm);
